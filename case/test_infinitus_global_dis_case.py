...
# )
# 测试用例
class Test_Main_Case_Global_DIS(unittest.TestCase, PageCommon):
    # 出错需要截图时此方法自动被调用
    ...
    def test_1_dis_login_global(self):
        '''测试global站dis账号会员卡+密码登录'''
        # log 信息
    ...
    #@unittest.skip("暂时跳过")
    # 通过商品搜索并添加购物车
    #@BeautifulReport.add_test_img(ScreenshotTool().get_img_name("../../report/img/test_2_searchandadd_tw"))
    def test_2_searchandadd_global(self):
        '''测试global站dis账号搜索商品并添加购物车'''
        # log 信息
    ...
    #@unittest.skip("暂时跳过")
    #通过分类筛选并添加购物车
    #@BeautifulReport.add_test_img(ScreenshotTool().get_img_name("../../report/img/test_3_cateandadd_tw"))
    def test_3_cateandadd_global(self):
        '''测试global站dis账号筛选商品并添加购物车'''
        # log 信息
    ...
    #@unittest.skip("暂时跳过")
    #@BeautifulReport.add_test_img(ScreenshotTool().get_img_name("../../report/img/test_4_checkout_tw"))
    def test_4_checkout_global(self):
        '''测试global站dis账号结账'''
        # log 信息
        log().info(f"测试vip结账")
        #搜索商品加入购物车
